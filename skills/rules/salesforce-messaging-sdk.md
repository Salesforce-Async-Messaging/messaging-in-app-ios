...
If the fetch fails, you may proceed using the api-surface reference as your source
of truth for type names and method signatures. Do NOT generate SDK code purely from
memory -- always verify against either the fetched example or the api-surface reference.
